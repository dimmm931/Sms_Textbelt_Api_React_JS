...
// **************************************************************************************
//                                                                                     ** 
export const myValidate =(thisX, id, regExp, butttonToDisable,  messageErr, messageSuccess, e) =>{ //{e} -. it is change event from {$(document).on("change", '.fileCheck', function(e) { }
